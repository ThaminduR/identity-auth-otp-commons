...
public class AbstractOTPExecutorTest {
    ...
    public void testIsResendRequest() {
        ...
        flowExecutionContext.getUserInputData().remove(OTPExecutorConstants.RESEND);
        flowExecutionContext.getUserInputData().put(OTPExecutorConstants.SEND_OTP,
                OTPExecutorConstants.RESEND_ACTION);
        Assert.assertTrue(testOTPExecutor.isResendRequest(flowExecutionContext));

        flowExecutionContext.getUserInputData().put(OTPExecutorConstants.SEND_OTP, "INITIAL");
        Assert.assertFalse(testOTPExecutor.isResendRequest(flowExecutionContext));
    }

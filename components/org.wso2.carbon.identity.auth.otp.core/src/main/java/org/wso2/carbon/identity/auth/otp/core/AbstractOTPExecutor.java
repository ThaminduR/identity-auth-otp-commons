...
public abstract class AbstractOTPExecutor extends AuthenticationExecutor {
    ...
    protected boolean isResendRequest(FlowExecutionContext flowExecutionContext) {
        ...
        String sendOTPAction = userInputData.get(OTPExecutorConstants.SEND_OTP);
        return StringUtils.equalsIgnoreCase(sendOTPAction, OTPExecutorConstants.RESEND_ACTION);
    }
